...
# Tampilkan dataset di homepage
if analysis_option == "Homepage":
    st.title("📊 Sales and RFM Analysis Dashboard by Moofeed")
    st.write(
...
# Analisis 1: Penjualan Tertinggi dan Terendah per Kategori
    ...
    fig_top = px.bar(top_categories, x='Category',
                     y='Total Sales', title='Top 10 Categories by Sales')
